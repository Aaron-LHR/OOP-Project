...
public class ChatRoomClient1 extends JFrame {
...
//        textArea.append(ret[1] + ":" + ret[2] + "\n");
    ...
    public static void main(String[] args) {
        try {
            ChatRoomClient1 frame = new ChatRoomClient1();
            frame.setVisible(true);
            frame.client.Login("abc", "123");
...
//			in.next();
     ...
     * Create the frame.
     */
    public ChatRoomClient1() throws IOException {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    client.send("cdf", textField.getText());
